...
if model_checkpoint:
    ...
    # 注意：这里使用中文词汇表作为源语言，匈牙利语词汇表作为目标语言
    model = TranslationModel(256, dataset.zh_vocab, dataset.hun_vocab, max_seq_length, device)
...
if __name__ == "__main__":
    ...
    print(f"英文词汇表大小: {len(dataset.zh_vocab)}")
    print(f"匈牙利语词汇表大小: {len(dataset.hun_vocab)}")
    print("开始训练...")
    train()
